 ...
 */
package jcalendar.jcalendar.src.com.toedter.calendar;

import jcalendar.jcalendar.src.com.toedter.components.JLocaleChooser;
import jcalendar.jcalendar.src.com.toedter.components.JSpinField;
import jcalendar.jcalendar.src.com.toedter.components.JTitlePanel;
    ...
    private void installBean(JComponent bean) {
        try {
            ...
            String[] types = new String[] {
                    "class java.util.Locale", "boolean", "int", "class java.awt.Color",
